    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_file_rename:
                ...
                break;
            case R.id.btn_android5:
                //android 5.0新特性
                startActivity(new Intent(this, Android5MainActivity.class));
                break;
            case R.id.btn_expandable_item:
                //分组的伸缩栏(ExpandableItemAdapter)
                startActivity(new Intent(this, ExpandableItemActivity.class));
                break;
            case R.id.btn_c_call_java:
                //C&Java互调测试
                startActivity(new Intent(this, CCallJavaActivity.class));
                break;
            case R.id.btn_github_host:
                //获取 Github Host(用于配置电脑host,解决Github图片等无法访问等问题.)
